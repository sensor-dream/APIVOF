...
```
From repo    : fedora
Short desc   : Build and distribute virtualized development environments
URL          : http://vagrantup.com
License      : MIT
Descript     : Vagrant is a tool for building and distributing virtualized development
             : environments.
```
...
<details>
<summary>vagrant-libvirt</summary>

```
From repo    : fedora
Short desc   : libvirt provider for Vagrant
URL          : https://github.com/vagrant-libvirt/vagrant-libvirt
License      : MIT
Descript     : libvirt provider for Vagrant.
```
