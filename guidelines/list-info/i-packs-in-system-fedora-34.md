...
<details>
<summary>iniparser</summary>

```
From repo    : fedora
Short desc   : C library for parsing "INI-style" files
URL          : https://github.com/ndevilla/iniparser
License      : MIT
Descript     : iniParser is an ANSI C library to parse "INI-style" files, often used to
