# For letter D, information about installed packages
...
```
Из репозитор : fedora
Краткое опис : A cross-platform image library
URL          : http://openil.sourceforge.net/
Лицензия     : LGPLv2
Описание     : Developer's Image Library (DevIL) is a programmer's library to develop
