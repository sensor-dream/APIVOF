...
Descript     : GStreamer is a streaming media framework, based on graphs of filters
             ...
             : good quality and under the LGPL license.
             : 
             : gstreamer1-plugins-good-extras contains extra "good" plugins
...
Descript     : GStreamer is a streaming media framework, based on graphs of elements which
             ...
             : good quality and under the LGPL license.
             : 
             : This package (gstreamer1-plugins-good-qt) contains the qtsink output plugin.
```
...
<details>
<summary>guestfs-tools</summary>

```
From repo    : updates
Short desc   : Tools to access and modify virtual machine disk images
URL          : http://libguestfs.org/
License      : GPLv2+
Descript     : guestfs-tools is a set of tools that can be used to make batch
