# For first letter u, information about installation packages
...
Descript     : The ufraw-gimp package contains a GIMP plugin for opening raw format images of
             ...
             : 
             : 
             : Obsoletes: ufraw-cinepaint < 0.19.2-4
```
...
Descript     : NGINX Unit is a runtime and delivery environment for modern distributed
             ...
             : directly in the cloud / container environments and fully control your app
             : dynamically via an API.
             : This package contains Go module for NGINX Unit.
```
...
Descript     : NGINX Unit is a runtime and delivery environment for modern distributed
             ...
             : directly in the cloud / container environments and fully control your app
             : dynamically via an API.
             : This package contains Java shared packages for NGINX Unit.
```
...
Descript     : NGINX Unit is a runtime and delivery environment for modern distributed
             ...
             : directly in the cloud / container environments and fully control your app
             : dynamically via an API.
             : This package contains Java 11 module for NGINX Unit.
```
...
Descript     : NGINX Unit is a runtime and delivery environment for modern distributed
             ...
             : directly in the cloud / container environments and fully control your app
             : dynamically via an API.
             : This package contains Java 8 module for NGINX Unit.
```
...
Descript     : NGINX Unit is a runtime and delivery environment for modern distributed
             ...
             : directly in the cloud / container environments and fully control your app
             : dynamically via an API.
             : This package contains Perl module for NGINX Unit.
```
...
Descript     : NGINX Unit is a runtime and delivery environment for modern distributed
             ...
             : directly in the cloud / container environments and fully control your app
             : dynamically via an API.
             : This package contains PHP module for NGINX Unit.
```
...
Descript     : NGINX Unit is a runtime and delivery environment for modern distributed
             ...
             : directly in the cloud / container environments and fully control your app
             : dynamically via an API.
             : This package contains Python 3.9 module for NGINX Unit.
```
