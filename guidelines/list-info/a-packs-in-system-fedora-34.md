# For first letter a, information about installation packages
...
<details>
<summary>akmod-VirtualBox</summary>

```
From repo    : rpmfusion-free
Short desc   : Akmod package for VirtualBox kernel module(s)
URL          : http://www.virtualbox.org/wiki/VirtualBox
License      : GPLv2 or CDDL
Descript     : This package provides the akmod package for the VirtualBox kernel modules.
```
...
Descript     : The augeas-devel package contains libraries and header files for
             : developing applications that use augeas.
```
