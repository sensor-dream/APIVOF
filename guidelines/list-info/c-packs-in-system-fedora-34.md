...
<details>
<summary>cdbs</summary>

```
From repo    : fedora
Short desc   : Common build system for Debian packages
URL          : https://salsa.debian.org/build-common-team/cdbs
License      : GPLv2+
Descript     : This package contains the Common Debian Build System, an abstract build system
...
```
From repo    : gitlab.com_paulcarroty_vscodium_repo
Short desc   : Code editing. Redefined.
URL          : https://vscodium.com/
License      : MIT
Descript     : VSCodium is a new choice of tool that combines the simplicity of a code editor with what developers need for the core edit-build-debug cycle. See https://github.com/VSCodium/vscodium#download-install for installation instructions and FAQ.
```
